    ...
    <div className="p-8">
      ...
      <div className="flex items-center justify-between">
        <button
          ...
          className="px-4 h-10 rounded-lg flex items-center gap-2 transition-opacity"
          style={{ 
        ...
        <button
          ...
          className="px-4 h-10 rounded-lg flex items-center gap-2 transition-opacity hover:opacity-90"
          style={{ 
